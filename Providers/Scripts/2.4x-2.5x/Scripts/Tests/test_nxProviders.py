...
nxOMSSudoCustomLogTestCases = unittest2.skipUnless(os.system('ps -ef | grep -v grep | grep omsagent') ==
                      0,'Skipping nxOMSSudoCustomLogTestCases.   omsagent is not running.')(nxOMSSudoCustomLogTestCases)
